...
// Auto-generated page for: No equity-analysis AI synthesizing community impact

export default function GapNoEquityAnalysisAiSynthesizingCommu() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const res = await fetch('/api/gap-no-equity-analysis-ai-synthesizing-commu', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: '2rem', maxWidth: '900px', margin: '0 auto' }}>
      <h1 style={{ fontSize: '1.75rem', marginBottom: '0.5rem' }}>No equity-analysis AI synthesizing community impact</h1>
      <p style={{ color: '#666', marginBottom: '1.5rem' }}>No equity-analysis AI synthesizing community impact</p>
      <form onSubmit={handleSubmit} style={{ marginBottom: '1.5rem' }}>
        ...
        >
          {loading ? 'Processing...' : 'Run No equity-analysis AI synthesizing community impact'}
        </button>
      </form>
