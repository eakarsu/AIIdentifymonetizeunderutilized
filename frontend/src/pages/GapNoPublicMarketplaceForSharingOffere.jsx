...
// Auto-generated page for: No public marketplace for sharing offered spaces

export default function GapNoPublicMarketplaceForSharingOffere() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const res = await fetch('/api/gap-no-public-marketplace-for-sharing-offere', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: '2rem', maxWidth: '900px', margin: '0 auto' }}>
      <h1 style={{ fontSize: '1.75rem', marginBottom: '0.5rem' }}>No public marketplace for sharing offered spaces</h1>
      <p style={{ color: '#666', marginBottom: '1.5rem' }}>No public marketplace for sharing offered spaces</p>
      <form onSubmit={handleSubmit} style={{ marginBottom: '1.5rem' }}>
        ...
        >
          {loading ? 'Processing...' : 'Run No public marketplace for sharing offered spaces'}
        </button>
      </form>
