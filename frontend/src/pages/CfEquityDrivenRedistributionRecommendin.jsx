...
// Auto-generated page for: Equity-driven redistribution recommending allocation across 

export default function CfEquityDrivenRedistributionRecommendin() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const res = await fetch('/api/cf-equity-driven-redistribution-recommendin', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: '2rem', maxWidth: '900px', margin: '0 auto' }}>
      <h1 style={{ fontSize: '1.75rem', marginBottom: '0.5rem' }}>Equity-driven redistribution recommending allocation across </h1>
      <p style={{ color: '#666', marginBottom: '1.5rem' }}>Equity-driven redistribution recommending allocation across neighborhoods.</p>
      <form onSubmit={handleSubmit} style={{ marginBottom: '1.5rem' }}>
        ...
        >
          {loading ? 'Processing...' : 'Run Equity-driven redistribution recommending allocation across '}
        </button>
      </form>
