...
// Auto-generated page for: Community impact modeling quantifying jobs, energy savings, 

export default function CfCommunityImpactModelingQuantifyingJo() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const res = await fetch('/api/cf-community-impact-modeling-quantifying-jo', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: '2rem', maxWidth: '900px', margin: '0 auto' }}>
      <h1 style={{ fontSize: '1.75rem', marginBottom: '0.5rem' }}>Community impact modeling quantifying jobs, energy savings, </h1>
      <p style={{ color: '#666', marginBottom: '1.5rem' }}>Community impact modeling quantifying jobs, energy savings, community benefit.</p>
      <form onSubmit={handleSubmit} style={{ marginBottom: '1.5rem' }}>
        ...
        >
          {loading ? 'Processing...' : 'Run Community impact modeling quantifying jobs, energy savings, '}
        </button>
      </form>
