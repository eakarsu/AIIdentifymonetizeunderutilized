...
// Auto-generated page for: No utilization-opportunity finder endpoint

export default function GapNoUtilizationOpportunityFinderEndpoi() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const res = await fetch('/api/gap-no-utilization-opportunity-finder-endpoi', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: '2rem', maxWidth: '900px', margin: '0 auto' }}>
      <h1 style={{ fontSize: '1.75rem', marginBottom: '0.5rem' }}>No utilization-opportunity finder endpoint</h1>
      <p style={{ color: '#666', marginBottom: '1.5rem' }}>No utilization-opportunity finder endpoint</p>
      <form onSubmit={handleSubmit} style={{ marginBottom: '1.5rem' }}>
        ...
        >
          {loading ? 'Processing...' : 'Run No utilization-opportunity finder endpoint'}
        </button>
      </form>
