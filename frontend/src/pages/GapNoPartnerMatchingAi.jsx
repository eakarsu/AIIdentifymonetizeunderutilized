...
// Auto-generated page for: No partner-matching AI

export default function GapNoPartnerMatchingAi() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const res = await fetch('/api/gap-no-partner-matching-ai', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: '2rem', maxWidth: '900px', margin: '0 auto' }}>
      <h1 style={{ fontSize: '1.75rem', marginBottom: '0.5rem' }}>No partner-matching AI</h1>
      <p style={{ color: '#666', marginBottom: '1.5rem' }}>No partner-matching AI</p>
      <form onSubmit={handleSubmit} style={{ marginBottom: '1.5rem' }}>
        ...
        >
          {loading ? 'Processing...' : 'Run No partner-matching AI'}
        </button>
      </form>
