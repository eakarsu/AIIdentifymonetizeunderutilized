...
// Auto-generated page for: No pricing recommender for underutilized space

export default function GapNoPricingRecommenderForUnderutilized() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const res = await fetch('/api/gap-no-pricing-recommender-for-underutilized', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: '2rem', maxWidth: '900px', margin: '0 auto' }}>
      <h1 style={{ fontSize: '1.75rem', marginBottom: '0.5rem' }}>No pricing recommender for underutilized space</h1>
      <p style={{ color: '#666', marginBottom: '1.5rem' }}>No pricing recommender for underutilized space</p>
      <form onSubmit={handleSubmit} style={{ marginBottom: '1.5rem' }}>
        ...
        >
          {loading ? 'Processing...' : 'Run No pricing recommender for underutilized space'}
        </button>
      </form>
